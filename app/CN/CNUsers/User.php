...
class User extends Model implements AuthenticatableContract, CanResetPasswordContract ,CustomModel{
	...
	use Authenticatable, CanResetPassword ,AuthenticatesAndRegistersUsers, ThrottlesLogins;
	 ...
	 * @var array
	 */
	protected $fillable = ['firstName','lastName','roleId','collegeId','email', 'password','deptId','avatarUrl'];
	...
	{
		return $this->belongsToMany('App\CN\CNPermissions\Permission');
	}
